...
import LaunchingSlider from './components/LaunchingSlider';
...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden lg:min-h-screen flex items-center py-20 md:py-20 lg:py-0">
      {/* Base background */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-8 w-full pt-16 lg:pt-20">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
          ...
          {/* Right: Slider */}
          <div className="lg:w-1/2 w-full px-2 sm:px-4 lg:px-0 pb-4 lg:pb-0">
            <LaunchingSlider />
          </div>
        </div>
      </div>
